...
namespace InstitutoAdecco.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        private readonly ISiteUtils _siteUtils;
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (!is2faTokenValid)
            {
                ModelState.AddModelError("Input.Code", L["Verification code is invalid."]);
                await LoadSharedKeyAndQrCodeUriAsync(user);
                return Page();
            }
            ...
            StatusMessage = L["Your authenticator app has been verified."];
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode(_siteUtils.GetSiteName()),
