...
namespace InstitutoAdecco.Areas.Identity.Pages.Account.Manage
{
    public class ExternalLoginsModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostRemoveLoginAsync(string loginProvider, string providerKey)
        {
            ...
            if (!result.Succeeded)
            {
                StatusMessage = L["The external login was not removed."];
                return RedirectToPage();
            }

            await _signInManager.RefreshSignInAsync(user);
            StatusMessage = L["The external login was removed."];
            return RedirectToPage();
        }
        ...
        public async Task<IActionResult> OnGetLinkLoginCallbackAsync()
        {
            ...
            if (!result.Succeeded)
            {
                StatusMessage = L["The external login was not added. External logins can only be associated with one account."];
                return RedirectToPage();
            }
            ...
            StatusMessage = L["The external login was added."];
            return RedirectToPage();
        }
    }
}
